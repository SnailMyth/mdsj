...
//    private OnProgressBarListener mListener;
    ...
    private void calculateDrawRectF() {
        BigDecimal percent = new BigDecimal(getProgress()).setScale(2, RoundingMode.HALF_UP).multiply(new BigDecimal(100f)).divide(new BigDecimal(getMax()), RoundingMode.HALF_UP);
        mCurrentDrawText = String.valueOf(percent.floatValue());
