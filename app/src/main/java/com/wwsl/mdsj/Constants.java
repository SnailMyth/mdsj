...
public class Constants {
    ...
    public static final String APK_FILE_NAME = "mdsj.apk";
    ...
    public static final int MESSAGE_SUBTYPE_ASSISTANT_SHOP = 3;//毛豆助手
    ...
    public static final int EXCHANGE_TYPE_DOUDING = 0;//豆丁兑换
    public static final int EXCHANGE_TYPE_BALANCE = 1;//余额提现
    public static final int EXCHANGE_TYPE_DD_DEPOSIT = 2;//福利豆丁提现
    public static final int EXCHANGE_TYPE_DD_2_BALANCE = 3;//福利豆丁转换余额
     ...
     * 单聊时对方ID
     */
    public static final String CHAT_STATUS = "talk_id";
